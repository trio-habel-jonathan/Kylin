  ...
  return (
    <div className="relative h-[34rem] w-full bg-slate-50 dark:bg-black text-black dark:text-white overflow-hidden flex flex-col items-center justify-center py-10">
      ...
      >
        ...
        >
          We are committed to crafting cutting-edge solutions that make a real
          impact, both in the Web2 and Web3 spaces. Our team is driven by
          excellence, innovation, and a constant pursuit of growth.
        </motion.p>
      </motion.div>
    </div>
  );
