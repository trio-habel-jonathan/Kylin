    ...
    <>
      ...
      <section>
        <div className="w-full h-full">
          <div className="w-full h-full flex flex-col justify-center py-24 px-4 sm:px-8 md:px-12 lg:px-24 xl:px-48 gap-12">
      ...
      <section>
        <div className="w-full h-full bg-gradient-to-b from-slate-50 to-white dark:from-black dark:to-gray-900">
          <div className="w-full grid grid-cols-1 lg:grid-cols-2 py-24 px-4 sm:px-8 md:px-12 lg:px-24 xl:px-48 gap-24">
            <div className="montserrat-font space-y-4">
              <h6>FAQ</h6>
            ...
            <div className="space-y-4 montserrat-font">
              ...
              <p>
                Here you'll find answers to common questions to help you use our
                platform more easily. If you need more help or can't find what
                you're looking for, feel free to reach out through our contact
              ...
              <div className="space-y-4">
                {faqItems.map((item, index) => (
                  ...
                  >
                    ...
                    <div
                      className={`pr-6 overflow-hidden text-sm transition-all duration-300 ${
